...
const FALLBACK_PROJECTS: any[] = [
  {
    ...
    coverMedia: { url: 'https://images.unsplash.com/photo-1541888087616-5ca7336fbf43?q=80&w=800&auto=format&fit=crop', type: 'IMAGE', altText: 'Institutional Integration' },
    industry: {
